...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'Go shopping' => 'Faire des achats',
    'If this is a recurring problem, please [1]contact us[/1]' => 'Si cela est un problème récurrent, veuillez [1]nous contacter[1]',
    'Image' => 'Image',
    'In stock' => 'En stock',
    'Including %amount% for ecotax' => 'Dont %amount% d\'éco-participation',
    'Instead of %price%' => 'Au lieu de %price%',
    'It can not be reached anymore. Can we still attract you into our shop?' => 'Ce contenu est introuvable. Revenez faire un tour sur la boutique ?',
    'Item' => 'Article',
    'Items' => 'Produits',
    ...
    'No search results for "%search_term%"' => 'Aucun résultat de la recherche pour "%search_term%"',
    'No supplier' => 'Aucun fournisseur',
    'No tax' => 'Aucune taxe',
    'Nothing to search for' => 'Aucune recherche à faire',
    'On sale' => 'En promo',
    'On sale!' => 'Promo !',
    ...
    'Product image %number%' => 'Image produit %number%',
    'Products pagination' => 'Pagination des produits',
    'Quantity' => 'Quantité',
    ...
    'Search results for "%search_term%"' => 'Résultats de la recherche pour "%search_term%"',
    'Select' => 'Choisir',
    ...
    'The page you are looking for is no longer available' => 'La page que vous recherchez n\'est plus disponible',
  ...
  array (
    ...
    'Product "Available for order" settings is invalid.' => 'Les paramètres du produit "Disponible pour la commande" sont invalides.',
    'Product "Low stock alert" settings is invalid.' => 'Les paramètres "Alerte de stock faible" du produit sont invalides.',
    'Product "Redirection when offline" behavior is invalid.' => 'Le comportement du produit "Redirection lorsque hors ligne" est invalide.',
    'Product "Redirection when offline" target is invalid.' => 'La cible "Redirection lorsque hors ligne" du produit n\'est pas valide.',
    'Product "Show condition" settings is invalid.' => 'Les paramètres « Afficher les conditions» du produit sont invalides.',
    'Product "Show price" settings is invalid.' => 'Les paramètres "Afficher le prix" du produit sont invalides.',
    'Product "Web only" settings is invalid.' => 'Les paramètres du produit "Web seulement" sont invalides.',
    'Product EAN13 field is invalid.' => 'Le champ produit EAN13 est invalide.',
    'Product GTIN field is invalid.' => 'Le champ GTIN du produit est invalide.',
    'Product ID is invalid.' => 'L\'ID du produit n\'est pas valide.',
    'Product ISBN field is invalid.' => 'Le champ produit ISBN est invalide.',
    'Product MPN field is invalid.' => 'Le champ MPN du produit est invalide.',
    'Product UPC field is invalid.' => 'Le champ UPC du produit est invalide.',
    'Product additional shipping cost is invalid.' => 'Les frais de port supplémentaires du produit ne sont pas valides.',
    'Product availability date is invalid.' => 'La date de disponibilité du produit n\'est pas valide.',
    'Product availability label when in stock is invalid.' => 'Étiquette de disponibilité du produit lorsqu\'elle est en stock est invalide.',
    'Product availability label when out of stock is invalid.' => 'Étiquette de disponibilité du produit en cas de rupture de stock est invalide.',
    'Product condition is invalid.' => 'La condition du produit est invalide.',
    ...
    'Product customization fields are invalid.' => 'Les champs de personnalisation du produit ne sont pas valides.',
    'Product delivery time when in stock are invalid.' => 'Délai de livraison du produit en stock est invalide.',
    'Product delivery times are invalid.' => 'Les délais de livraison du produit ne sont pas valides.',
    'Product delivery times when out of stock are invalid.' => 'Les délais de livraison des produits en rupture de stock ne sont pas valides.',
    'Product depth is invalid.' => 'La profondeur du produit est invalide.',
    'Product description is invalid.' => 'La description du produit est invalide.',
    'Product doesn\'t have the minimum data to go online.' => 'Le produit n\'a pas les données minimales pour être publié.',
    'Product ecotax is invalid.' => 'L\'écotaxe du produit n\'est pas valide.',
    'Product file customization fields is invalid.' => 'Les champs de personnalisation du fichier produit sont invalides.',
    'Product friendly URL is invalid.' => 'L\'URL simplifiée du produit n\'est pas valide.',
    'Product height is invalid.' => 'La hauteur du produit n\'est pas valide.',
    'Product low stock alert treshold is invalid.' => 'La seuil d\'alerte de stock du produit est invalide.',
    'Product manufacturer is invalid.' => 'Le fabricant du produit est invalide.',
    'Product meta description is invalid.' => 'La méta description du produit n\'est pas valide.',
    'Product meta title is invalid.' => 'Le méta titre du produit n\'est pas valide.',
    'Product minimum quantity for sale is invalid.' => 'La quantité minimale de produit à vendre n\'est pas valide.',
    'Product name is invalid.' => 'Le nom du produit est invalide.',
    'Product reference is invalid.' => 'La référence de produit n\'est pas valide.',
    'Product short description is invalid.' => 'La description courte du produit n\'est pas valide.',
    'Product status (active/inactive) is invalid.' => 'Le statut du produit (actif/inactif) n\'est pas valide.',
    'Product tags are invalid.' => 'Les tags de produit ne sont pas valides.',
    'Product text customization fields are invalid.' => 'Les champs de personnalisation du texte du produit ne sont pas valides.',
    'Product type is invalid.' => 'Le type de produit est invalide.',
    'Product unit in "price per unit" is invalid.' => 'L\'unité de produit dans "prix par unité" n\'est pas valide.',
    'Product visibility settings is invalid.' => 'Les paramètres de visibilité du produit sont invalides.',
    'Product weight is invalid.' => 'Le poids du produit est invalide.',
    'Product wholesale price is invalid.' => 'Le prix coutant du produit n\'est pas valide.',
    'Product width is invalid.' => 'La largeur du produit est invalide.',
    ...
    'Search phrase length is not valid.' => 'La longueur de la phrase de recherche n\'est pas valide.',
    'Search phrase limit is not valid.' => 'La limite de phrase de recherche n\'est pas valide.',
  ...
  array (
    ...
    'Please send us a bank transfer with following details:' => 'Veuillez nous envoyer un virement bancaire avec les informations suivantes :',
    ...
    'You have chosen payment by bank transfer.' => 'Vous avez choisi le paiement par virement bancaire.',
...
',
  ...
  array (
    ...
    '%s import' => 'Import : %s',
    '%s is invalid. Please enter an integer between %s and %s.' => '%s est invalide. Veuillez entrer un nombre entre %s et %s.',
  ...
  array (
    ...
    'Does the carrier have additional fees' => 'Est-ce que le transporteur a des frais supplémentaires',
    ...
    'Maximum depth managed by this carrier. Set the value to "0" to ignore.' => 'Profondeur maximale gérée par ce transporteur. Réglez la valeur sur « 0 » pour l\'ignorer.',
    ...
    'Maximum height managed by this carrier. Set the value to "0" to ignore.' => 'Hauteur maximale gérée par ce transporteur. Réglez la valeur sur « 0 » pour l\'ignorer.',
    ...
    'Maximum weight managed by this carrier. Set the value to "0" to ignore.' => 'Poids maximal géré par ce transporteur. Réglez la valeur sur « 0 » pour l\'ignorer.',
    ...
    'Maximum width managed by this carrier. Set the value to "0" to ignore.' => 'Largeur maximale gérée par ce transporteur. Réglez la valeur sur « 0 » pour l\'ignorer.',
    ...
    'Zones that the carrier can handle' => 'Zone sur laquelle le transporteur peut intervenir',
    'or' => 'OU',
    'undefined' => 'indéfini',
  ),
  ...
  array (
    ...
    'Background color of this status label. Used both in backoffice and on order tracking page. HTML colors only.' => 'Couleur d\'arrière-plan de cette étiquette d\'état. Utilisé à la fois dans le back-office et sur la page de suivi de la commande. Couleurs HTML uniquement.',
    ...
    'If order\'s invoice is not generated yet, this will generate it.' => 'Si la facture de la commande n\'est pas encore générée, elle sera générée.',
    'If there are multiple languages enabled on the shop, all URLs are prefixed with the ISO code of the language. Do you want to do this also for the default language, or keep it un-prefixed? If adding a language to a well established single language shop, it\'s a good idea to disable this and avoid changing the URLs.' => 'Si plusieurs langues sont activées dans la boutique, toutes les URL sont préfixées du code ISO de la langue. Souhaitez-vous faire de même pour la langue par défaut ou ne pas la préfixer ? Si vous ajoutez une langue à une boutique unilingue bien établie, il est préférable de désactiver cette option et d\'éviter de modifier les URL.',
    ...
    'Image of this status used in the backoffice. (File type: .gif, suggested size: 16x16).' => 'Image de cet état utilisée dans le backoffice. (Type de fichier : .gif, taille suggérée: 16x16).',
    'Image width in pixels. Enter "0" to use the original size.' => 'Largeur de l\'image en pixels. "0" pour utiliser la taille originale.',
    'In stock' => 'En stock',
    'In the product page, feature values can be sorted alphabetically by value or by position.' => 'Dans la page produit, les valeurs des fonctionnalités peuvent être triées par ordre alphabétique ou par leur position dans la liste.',
    ...
    'Select an email template that will be sent after setting this status.' => 'Sélectionnez un modèle d\'e-mail qui sera envoyé après avoir défini ce statut.',
    ...
    'This option defines how much different can the alternative words found by fuzzy search be. Or, how many characters can be different/missing/added. The default value is 5.' => 'Cette option définit le degré de différence entre les mots alternatifs trouvés par la recherche fuzzy. Ou, combien de caractères peuvent être différents/manquants/ajoutés. La valeur par défaut est 5.',
    ...
    'This will add an entry to order\'s "Payments" table, if it doesn\'t exist yet.' => 'Cela ajoutera une entrée à la table "Paiements" de la commande si elle n\'existe pas encore.',
    'This will attach delivery slip PDF to the sent email, if it exists. If it doesn\'t, it will have no effect.' => 'Cela attachera le bon de livraison PDF à l\'e-mail envoyé, s\'il existe. Si ce n\'est pas le cas, il n\'aura aucun effet.',
    'This will attach invoice PDF to the sent email, if it exists. If it doesn\'t, it will have no effect.' => 'Cela attachera la facture PDF à l\'e-mail envoyé, s\'il existe. Si ce n\'est pas le cas, cela n\'aura aucun effet.',
    'This will create a delivery slip and mark a delivery date on order\'s invoice.' => 'Cela créera un bon de livraison et marquera une date de livraison sur la facture de la commande.',
    'This will mark the order as shipped. It will register a stock movement entry, prevent modifying the order and other things.' => 'Ceci marquera la commande comme livrée. Il enregistrera une entrée de mouvement de stock, empêchera de modifier la commande et d\'autres choses.',
    'This will mark the order as successfuly processed - including it in customer\'s revenue, your shop stats etc.' => 'Ceci marquera la commande comme étant traitée avec succès - y compris dans les revenus du client, les statistiques de votre boutique, etc.',
    'This will send an email to the customer after assigning this status. Make sure to select proper email template below.' => 'Ceci enverra un e-mail au client après l\'assignation de ce statut. Assurez-vous de sélectionner le modèle d\'e-mail approprié ci-dessous.',
    ...
    'Use this if you want this status to be internal only.' => 'Utilisez ceci si vous voulez que ce statut soit interne.',
...
Vos clients peuvent cependant vous contacter à tout moment via votre formulaire de contact. Vous pouvez alors examiner leur demande; une fois que vous l\'aurez acceptée, vous pourrez supprimer leurs données personnelles directement dans la page de configuration de notre module officiel de conformité RGPD.',
  ...
  array (
    ...
    'Only available keywords for a given route can be used' => 'Seules les mots-clés disponibles pour une route donnée peuvent être utilisés.',
  ...
  array (
    ...
    'By default, the closest active parent category will be used if no category is selected.' => 'Par défaut, la catégorie parente active la plus proche sera utilisée si aucune catégorie n\'est sélectionnée.',
    ...
    'Category image that is usually displayed on the category page next to description, depending on your theme.' => 'Image de la catégorie qui est généralement affichée sur la page de la catégorie à côté de la description, en fonction de votre thème.',
    ...
    'Defines the product\'s primary placement, usually the deepest category in the hierarchy. It\'s used in breadcrumbs, URLs, structured data and many other parts of the shop.' => 'Définit le placement principal du produit, habituellement la catégorie la plus profonde de la hiérarchie. Il est utilisé dans les fils d\'ariane, les URL, les données structurées et de nombreuses autres parties de la boutique.',
    ...
    'Miniature image that is used when displaying subcategories. Could be also used in menus and other places, depending on your theme.' => 'Image miniature utilisée pour afficher les sous-catégories. Elle peut également être utilisée dans les menus et à d\'autres endroits, en fonction de votre thème.',
    ...
    'Text that is usually displayed after the product list on category page. It\'s a good place to put longer SEO related content.' => 'Texte qui s\'affiche généralement après la liste des produits sur la page des catégories. C\'est un bon endroit pour placer du contenu plus long lié au référencement.',
    ...
    'This will be the displayed availability of the combination, if it\'s not in stock. If you don\'t enter anything, the base value set on the product will be used.' => 'Il s\'agit de la disponibilité affichée de la combinaison, si elle n\'est pas en stock. Si vous n\'entrez rien, c\'est la valeur de base définie pour le produit qui sera utilisée.',
    'This will be the displayed availability of the combination, if there is at least 1 in stock. If you don\'t enter anything, the base value set on the product will be used.' => 'Il s\'agit de la disponibilité affichée de la combinaison, s\'il y en a au moins une en stock. Si vous n\'entrez rien, c\'est la valeur de base définie pour le produit qui sera utilisée.',
    'This will be the displayed availability of the product, if it\'s not in stock. If you don\'t enter anything, value from [1]Shop Parameters > Product Settings[/1] will be used.' => 'Il s\'agit de la disponibilité affichée du produit, s\'il n\'est pas en stock. Si vous n\'entrez rien, la valeur de [1]Paramètres de la boutique > Paramètres des produits[/1] sera utilisée.',
    'This will be the displayed availability of the product, if there is at least 1 in stock. If you don\'t enter anything, value from [1]Shop Parameters > Product Settings[/1] will be used.' => 'Il s\'agit de la disponibilité affichée du produit, s\'il y en a au moins un en stock. Si vous n\'entrez rien, la valeur de [1]Paramètres de la boutique > Paramètres des produits[/1] sera utilisée.',
...
d’inscriptions à votre newsletter.',
  ...
  array (
    ...
    'If you switch from a single-language shop to a multi-language setup, be aware that URLs may change depending on your URL settings.' => 'Si vous passez d\'une boutique de langue unique à une configuration multi-langue, sachez que les URL peuvent changer selon vos paramètres d\'URL.',
    'Important information regarding languages:' => 'Informations importantes concernant les langues :',
    ...
    'No tax' => 'Aucune taxe',
    'Only active languages are available to customers in the front office. You can still edit content in disabled languages in the back office - it just won\'t be visible to customers until the language is activated.' => 'Seules les langues actives sont disponibles pour les clients en front-office. Vous pouvez toujours modifier le contenu dans les langues désactivées dans le back office - il ne sera tout simplement pas visible pour les clients tant que la langue n\'est pas activée.',
    ...
    'When you delete a language, all content for all objects related to that language will be permanently removed from the database.' => 'Lorsque vous supprimez une langue, tout le contenu de tous les objets liés à cette langue sera définitivement supprimé de la base de données.',
  ...
  array (
    ...
    'Carrier' => 'Transporteur',
    'Carrier: ' => 'Transporteur: ',
    'Carrier: %carrierName%' => 'Transporteur : %carrierName%',
    'Cart' => 'Panier',
    'Close' => 'Fermer',
    'Code' => 'Code',
    ...
    'Next: Addresses' => 'Étape suivante : Adresses',
    'Next: Payment' => 'Étape suivante : Paiement',
    'Next: Shipping Method' => 'Étape suivante : Livraison',
    ...
    'Paste your voucher here' => 'Collez votre bon d\'achat ici',
    'Payment' => 'Paiement',
    ...
    'Quantity:' => 'Quantité :',
    'Remove' => 'Retirer',
    'Remove Voucher' => 'Supprimer le bon d\'achat',
    ...
    'Value' => 'Valeur',
    'View cart (%d products)' => 'Voir le panier (%d produits)',
    'Weight' => 'Poids',
    'Write a comment about this order' => 'Écrire un commentaire à propos de cette commande',
  ...
  array (
    ...
    'Starting module install: %s v%s' => 'Démarrage de l\'installation du module : %s v%s',
    'Starting module uninstall: %s v%s' => 'Démarrage de la désinstallation du module : %s v%s',
    'Starting module upgrade: %s v%s to v%s' => 'Démarrage de la mise à jour du module : %s v%s to v%s',
    ...
    'You are not allowed to upload modules.' => 'Vous n\'êtes pas autorisé à mettre en ligne des modules.',
  ...
  array (
    ...
    'Add range' => 'Ajouter une fourchette',
    ...
    'Apply the cost of the highest defined range' => 'Prendre la tranche la plus grande',
    'Based on the order\'s total price' => 'Basé sur le prix total de la commande',
    'Based on the order\'s total weight' => 'Basé sur le poids total de la commande',
    'Billing' => 'Facturation',
    'Carrier' => 'Transporteur',
    ...
    'For compatibility reasons, the original version remains enabled on your shop. If no incompatible modules are holding you back, feel free to switch to the new version. The legacy version will eventually be removed in a future release.' => 'Pour des raisons de compatibilité, la version originale reste activée sur votre boutique. Si aucun module incompatible ne vous en empêche, n\'hésitez pas à passer à la nouvelle version. La version héritée sera éventuellement supprimée dans une version ultérieure.',
    'Free Shipping' => 'Livraison gratuite',
    'Free shipping' => 'Livraison gratuite',
    ...
    'Make sure there are no overlapping ranges. Remember, the minimum is part of the range, but the maximum isn\'t. So, the upper limit of a range is the lower limit of the next range.' => 'Faites en sorte qu\'il n\'y ait pas de fourchette de prix qui se chevauchent. Pour rappel, le minimum est inclus, et le maximum est exclu. Donc la limite supérieure d\'une fourchette est la limite inférieure de la suivante.',
    'Manage ranges' => 'Gérer les fourchettes',
    'Manage your carriers' => 'Gérez vos transporteurs ',
    'Max order depth' => 'Profondeur maximale de la commande',
    'Max order height' => 'Hauteur maximale de la commande',
    'Max order weight' => 'Poids maximal de la commande',
    'Max order width' => 'Largeur maximale de la commande',
    'Maximum' => 'Maximum',
    ...
    'Minimum' => 'Minimum',
    'Name:' => 'Nom :',
    'Out of range behavior' => 'Comportement en dehors des limites de la fourchette',
    'Out-of-range behavior' => 'Comportement hors tranches',
    'Pick up in-store' => 'Retrait en magasin',
    'Please upload a valid jpeg file' => 'Veuillez charger un fichier jpeg valide',
    'Price (VAT excl.)' => 'Prix (hors taxe)',
    'Range' => 'Fourchette',
    'Ranges' => 'Plages',
    'Set ranges and prices' => 'Fixer des fourchettes et des prix',
    'Shipping and handling' => 'Frais de livraison',
    'Shipping cost' => 'Frais d\'expédition',
    'Shipping costs' => 'Frais de livraison',
    'Shipping locations and costs' => 'Destinations d\'expédition et coûts',
    'Shipping size and weight' => 'Dimensions et poids de livraison',
    'Size and weight' => 'Dimensions et poids',
    'Size, weight, and group access' => 'Taille, poids et groupes associés',
    'Speed grade' => 'Vitesse',
    'Tax' => 'Taxes',
    'The file is too large. Allowed maximum size is 8MB.' => 'Le fichier est trop gros. La taille autorisée est de 8Mo maximum.',
    ...
    'You can not add a negative range' => 'Vous ne pouvez pas ajouter une fourchette négative',
    'Zones' => 'Zones',
    '[1]A new, improved version of this page is ready.[/1] You can enable it with a single click in the [2]New & Experimental Features[/2] section.' => '[1]Une nouvelle version améliorée de cette page est disponible.[/1] Vous pouvez l\'activer en un clic dans la section [2]Fonctionnalités nouvelles et expérimentales[/2].',
    '[1]Manage handling costs[/1]' => '[1]Gérer les coûts de manutention[1]',
    '[1]Manage locations[/1]' => '[1]Gérer les lieux[1]',
    '[1]Manage taxes[/1]' => '[1]Gérer les taxes[1]',
...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.' => 'Attention ! Veuillez vérifier que votre thème est dans une langue RTL avant de générer une feuille de style RTL : votre thème pourrait déjà être compatible RTL. En cliquant sur "%generate_rtl_label%", n\'importe quel fichier spécifique au RTL que vous auriez ajouté à votre thème pourrait être supprimé par la feuille de style créée.',
    ...
    'Beware that to benefit from modern image formats, they must be supported by your theme.' => 'Attention, pour bénéficier des formats d\'image modernes, ceux-ci doivent être pris en charge par votre thème.',
    ...
    'Choose which image formats you want to be generated. Base image will always have .jpg extension, other formats will have .webp or .avif. Think twice before enabling all of them, because it can easily double the size of your shop.' => 'Choisissez les formats d\'image que vous souhaitez générer. L\'image de base aura toujours une extension .jpg, les autres formats auront une extension .webp ou .avif. Pensez-y à deux fois avant de tous les activer car cela peut facilement doubler la taille de votre boutique.',
    ...
    'Most common setup is to have the base JPG/PNG format and one modern WebP or AVIF format - the browser will choose the format it likes the most.' => 'La configuration la plus courante consiste à avoir à la fois un format de base JPG/PNG et un format moderne WebP ou AVIF - le navigateur choisira le format qu\'il préfère.',
    ...
    'The original images of objects you create are almost never used, optimized thumbnails are used instead. In this section, you can define the formats of thumbnails and their quality.' => 'Les images originales des objets que vous créez ne sont presque jamais utilisées, mais ce sont des miniatures optimisées qui sont utilisées à la place. Dans cette section, vous pouvez définir les formats de ces miniatures ainsi que leur qualité.',
  ...
  array (
    ...
    'JPEG images have a small file size and standard quality. PNG images have a larger file size, a higher quality and support transparency. Note that in all cases, these thumbnails will have .jpg extension.' => 'Les images JPEG ont une taille de fichier réduite et une qualité standard. Les images PNG ont une taille de fichier plus importante, une qualité supérieure et prennent en charge la transparence. Notez que dans tous les cas, ces vignettes porteront l\'extension .jpg.',
    ...
    'When applying a new theme to your store, make sure that the modules you are using are still compatible.' => 'Lorsque vous appliquez un nouveau thème à votre boutique, assurez-vous que les modules que vous utilisez sont toujours compatibles.',
  ...
  array (
    ...
    'Editing carrier %name%' => 'Modification du transporteur %name%',
  ...
  array (
    ...
    'Not you? [1]Sign out[/1]' => 'Ce n\'est pas vous ? [1]Se déconnecter[/1]',
    'Order' => 'Commande',
    ...
    'View my account (%s)' => 'Voir mon compte (%s)',
  ...
  array (
    ...
    'Customer private note' => 'Note privée du client',
    'Customer since: %s' => 'Client depuis : %s',
    ...
    'Free shipping' => 'Livraison gratuite',
    'From' => 'Du',
    'From %date1% to %date2% per unique visitors' => 'Depuis %date1% à %date2% par visiteur unique',
...
Cordialement,',
    ...
    'Order messages' => 'Messages prédéfinis',
    'Order private note' => 'Note privée pour la commande',
    'Order status' => 'État de la commande',
  ...
  array (
    ...
    'Indicate the minimum log levels that will be saved in database.' => 'Indique les niveaux de log minimum qui seront enregistrés en base de données.',
  ...
  array (
    ...
    'Back' => 'Précédent',
    'Basic information' => 'Informatique générale',
    'Behavior' => 'Comportement',
    'Below' => 'En dessous de',
    'Birth date' => 'Date de naissance',
    'Brand' => 'Marque',
    ...
    'Created from cart' => 'Créé depuis le panier',
    'Created on' => 'Créé le',
    'Currencies' => 'Devises',
    'Currency' => 'Devise',
    ...
    'Use prefix for default language' => 'Utilise un préfixe pour le langage par défaut',
    'Value' => 'Valeur',
    'Values' => 'Valeurs',
    'Version' => 'Version',
    'View' => 'Afficher',
  ...
  array (
    ...
    'IETF language tag (e.g. en-us, pt-br) in lower case.' => 'Tag du langage IETF (ex : en-US, fr-FR) en minuscule.',
    ...
    'Search locale' => 'Rechercher la locale',
  ...
  array (
    ...
    'The %1$s field is too short (%2$d chars min).' => 'Le champ %1$s est trop court (%2$d caractères min).',
...
',
  ...
  array (
    ...
    'Add to cart' => 'Ajouter au panier',
    'Apply' => 'Enregistrer',
    'Back to Addresses' => 'Retour vers "Adresses"',
    'Back to Login' => 'Retour à la connexion',
    'Back to Personal Information' => 'Retour vers "Informations Personnelles"',
    'Back to Shipping method' => 'Retour vers les méthodes de livraison',
    'Back to login' => 'Retour à la connexion',
    ...
    'Continue to Addresses' => 'Continuer vers "Adresses"',
    'Continue to Payment' => 'Continuer vers "Paiement"',
    'Continue to Shipping' => 'Continuer vers "Livraison"',
    'Create account' => 'Créez votre compte',
    ...
    'add new address' => 'ajouter une nouvelle adresse',
    'edit' => 'Modifier',
    'has been removed from the cart.' => 'a été retiré du panier.',
...
Le Service Client',
    ...
    'Don\'t display this status to the customer on order tracking page.' => 'Ne pas afficher ce statut au client sur la page de suivi de commande.',
    'Edit aliases for %s' => 'Éditer les alises pour %s',
    ...
    'Failed to delete alias.' => 'La suppression de l\'alias a échoué.',
    ...
    'Generate an invoice when order is assigned this status.' => 'Générer une facture lorsque la commande est assignée à cet état.',
    ...
    'Indexing' => 'Indexation',
    'Invalid alias ID.' => 'Cet ID d\'alias est invalide.',
    'Invalid alias.' => 'L\'alias est invalide.',
    'Invalid characters: numbers and' => 'Les caractères non valables : des chiffres et',
    'Invalid search term.' => 'Le terme de recherche est invalide.',
    ...
    'Maximum acceptable word difference' => 'Différence maximale de mot acceptable',
    ...
    'Order of feature values' => 'Ordre des valeurs de fonctionnalité',
    'Order status' => 'État de la commande',
    'Other' => 'Autre',
    'Out-of-Stock' => 'Rupture de stock',
    'Page' => 'Page',
    ...
    'Set the associated order as delivered.' => 'Définir la commande associée comme livrée.',
    'Set the associated order as paid.' => 'Définir la commande associée comme payée.',
    'Set the associated order as shipped.' => 'Définir la commande associée comme expédiée.',
    'Set the associated order as validated.' => 'Définir la commande associée comme validée.',
    ...
    'Show prices:' => 'Afficher les prix :',
    'Social title' => 'Titre',
    'Some alias are already in use for another search term: %s.' => 'Des alias sont déjà utilisés pour un autre terme de recherche : %s.',
...
Thanks for your patience.' => 'Notre boutique est en cours de mise à jour, nous revenons rapidement ! Merci pour votre patience.',
  ...
  array (
    ...
    'API Documentation (ReDoc)' => 'Documentation de l\'API (ReDoc)',
    ...
    'Both' => 'Les deux',
    'Both, with text format automatically generated' => 'Les deux, avec un format de texte généré automatiquement.',
  ...
  array (
    ...
    'You have been logged out for security reasons' => 'Vous avez été déconnecté pour des raisons de sécurité',
  ),
  'EmailsSubject' => 
  array (
  ...
  array (
    ...
    'You have chosen payment by check.' => 'Vous avez choisi le paiement par chèque.',
    'Your check must include following details:' => 'Votre chèque doit comporter les informations suivantes :',
...
clients grâce à la liste de vos meilleures ventes.',
  ...
  array (
    ...
    'Authorization not allowed for all stores.' => 'L\'autorisation n\'est pas permise pour toutes les boutiques.',
    'Authorization not allowed for this group of stores.' => 'L\'autorisation n\'est pas permise pour ce groupe de boutiques.',
    'Authorization not allowed for this store context.' => 'L\'autorisation n\'est pas permise pour le contexte de cette boutique.',
    'Authorization not allowed for this store.' => 'L\'autorisation n\'est pas permise pour cette boutique.',
    ...
    'Graph module could not be loaded.' => 'Ce module ne peut pas être chargé.',
    'Grid module could not be loaded.' => 'Ce module ne peut pas être chargé.',
    ...
    'Link to database cannot be established: %s' => 'La liaison avec la base de données ne peut pas être établie : %s',
    ...
    'PrestaShop Fatal error: no utf-8 support. Please check your server configuration.' => 'Erreur fatale : Format UTF-8 non supporté. Merci de vérifier la configuration de votre serveur.',
...
',
    ...
    'The page you\'re looking for could not be found. This might be due to a typo in the URL, an outdated link, or because the page was part of a module that is no longer installed.' => 'La page que vous recherchez est introuvable. Cela peut être dû à une faute de frappe dans l’URL, à un lien obsolète ou au fait que la page appartenait à un module qui n’est plus installé.',
    ...
    'The selected default page is not accessible by the selected profile.' => 'La page par défaut sélectionnée n\'est pas accessible par le profil sélectionné.',
...
suivre pour développer votre communauté.',
  ...
  array (
    ...
    'Interested in this product? Click below and we will let you know when it\'s available for order.' => 'Intéressé par ce produit ? Cliquez ci-dessous et nous vous informerons dès qu\'il est disponible pour passer commande',
    'Interested in this product? Drop us an email and we will let you know when it\'s available for order.' => 'Intéressé par ce produit ? Communiquez-nous votre adresse email et nous informerons dès qu\'il est disponible pour passer commande',
    'My alerts' => 'Mes alertes',
  ...
  array (
    ...
    'Virtual product, no delivery service.' => 'Produit virtuel, aucun service de livraison.',
  ...
  array (
    ...
    'The status of the selection has been successfully updated.' => 'Le statut de cette sélection a été mis à jour avec succès.',
  ...
  array (
    ...
    'To use PrestaShop, you must <a href="https://devdocs.prestashop-project.org/9/basics/installation/#creating-a-database-for-your-shop" target="_blank">create a database</a> to collect all of your store\'s data-related activities.' => 'Pour utiliser PrestaShop, vous devez <a href="https://devdocs.prestashop-project.org/9/basics/installation/#creating-a-database-for-your-shop" target="_blank">créer une base de données</a> afin de collecter toutes les données relatives à vos boutiques.',
    'Unable to generate private keys using openssl_pkey_new. Check your OpenSSL configuration, especially the path to openssl.cafile.' => 'Impossible de générer de clé privée à partir de openssl_pkey_new. Vérifiez votre configuration OpenSSL. Le problème peut être lié au chemin vers openssl.cafile.',
    'Version:' => 'Version :',
