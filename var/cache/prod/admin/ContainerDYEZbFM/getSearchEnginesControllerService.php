 ...
 */
class getSearchEnginesControllerService extends AdminKernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.UCPHT9s'] ?? $container->load('get_ServiceLocator_UCPHT9sService'))->withContext('PrestaShopBundle\\Controller\\Admin\\Configure\\ShopParameters\\SearchEnginesController', $container));
