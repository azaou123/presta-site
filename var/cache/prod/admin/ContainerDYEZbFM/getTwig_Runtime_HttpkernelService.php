 ...
 */
class getTwig_Runtime_HttpkernelService extends AdminKernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'hinclude' => '?',
            'inline' => '?',
        ]), $a, true), new \Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator('/_fragment', ($container->privates['uri_signer'] ??= new \Symfony\Component\HttpFoundation\UriSigner('zvVqqzhrG2kgPdyHsYsJL2InRGUKRBGqZB5QOwmOQ4AOJag4SSQOORsSxb3wMwhu')), $a));
    }
}
