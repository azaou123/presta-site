 ...
 */
class getLowStockThresholdTypeService extends AdminKernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\LowStockThresholdType'] = new \PrestaShopBundle\Form\Admin\Sell\Product\Combination\LowStockThresholdType(($container->services['Symfony\\Contracts\\Translation\\TranslatorInterface'] ?? self::getTranslatorInterfaceService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), $a);
    }
}
