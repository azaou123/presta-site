...
class TabRepositoryProxyAe893d8 extends \PrestaShopBundle\Entity\Repository\TabRepository implements \Symfony\Component\VarExporter\LazyObjectInterface
{
...
if (!\class_exists('TabRepositoryProxyAe893d8', false)) {
    \class_alias(__NAMESPACE__.'\\TabRepositoryProxyAe893d8', 'TabRepositoryProxyAe893d8', false);
}
