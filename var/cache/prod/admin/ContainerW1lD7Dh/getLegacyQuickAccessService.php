...
class getLegacyQuickAccessService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        $container->factories['service_container']['PrestaShopBundle\\Twig\\Component\\Legacy\\LegacyQuickAccess'] = function ($container) {
            $a = ($container->services['PrestaShop\\PrestaShop\\Core\\QuickAccess\\QuickAccessGenerator'] ?? $container->load('getQuickAccessGeneratorService'));
            ...
            return new \PrestaShopBundle\Twig\Component\Legacy\LegacyQuickAccess(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['PrestaShopBundle\\Twig\\Layout\\MenuBuilder'] ?? self::getMenuBuilderService($container)), $a);
        };
