...
";
    ...
    public function block_form_unit(array $context, array $blocks = []): iterable
    {
        ...
        // line 163
        yield "  ";
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, true, false, 163), "unit", [], "any", true, true, false, 163) &&  !CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 163), "prepend_unit", [], "any", false, false, false, 163))) {
            // line 164
            yield "    <div class=\"input-group-append\">
      <span class=\"input-group-text\">";
            // line 165
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 165), "unit", [], "any", false, false, false, 165), "html", null, true);
            yield "</span>
    </div>
  ";
        }
    ...
    public function block_form_unit_prepend(array $context, array $blocks = []): iterable
    {
        ...
        // line 171
        yield "  ";
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, true, false, 171), "unit", [], "any", true, true, false, 171) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 171), "prepend_unit", [], "any", false, false, false, 171))) {
            // line 172
            yield "    <div class=\"input-group-prepend\">
      <span class=\"input-group-text\">";
            // line 173
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 173), "unit", [], "any", false, false, false, 173), "html", null, true);
            yield "</span>
    </div>
  ";
        }
    ...
    <input id=\"";
        // line 180
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "amount", [], "any", false, false, false, 180), "vars", [], "any", false, false, false, 180), "id", [], "any", false, false, false, 180), "html", null, true);
        yield "\" type=\"text\" class=\"form-control\" name=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "amount", [], "any", false, false, false, 180), "vars", [], "any", false, false, false, 180), "full_name", [], "any", false, false, false, 180), "html", null, true);
        yield "\" required>
    <div class=\"input-group-append\">
      ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "amount", [], "any", false, true, false, 182), "vars", [], "any", false, true, false, 182), "unit", [], "any", true, true, false, 182)) {
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "amount", [], "any", false, false, false, 183), "vars", [], "any", false, false, false, 183), "unit", [], "any", false, false, false, 183), "html", null, true);
            yield "</span>
        ";
            // line 184
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "id_currency", [], "any", false, false, false, 184), 'widget');
            yield "
      ";
        } else {
            // line 186
            yield "        ";
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "id_currency", [], "any", false, false, false, 186), 'widget', ["attr" => ["class" => "form-control"]]);
            yield "
      ";
        }
        // line 188
...
";
    ...
    {
        return array (  615 => 188,  609 => 186,  604 => 184,  599 => 183,  597 => 182,  590 => 180,  587 => 179,  580 => 178,  571 => 173,  568 => 172,  565 => 171,  558 => 170,  549 => 165,  546 => 164,  543 => 163,  536 => 162,  531 => 159,  529 => 158,  527 => 157,  525 => 156,  523 => 155,  521 => 154,  514 => 153,  509 => 150,  507 => 149,  503 => 148,  501 => 147,  499 => 146,  497 => 145,  490 => 144,  484 => 141,  478 => 138,  475 => 137,  473 => 136,  470 => 135,  467 => 133,  464 => 131,  462 => 130,  460 => 128,  458 => 127,  455 => 126,  449 => 123,  446 => 122,  444 => 121,  441 => 120,  439 => 119,  436 => 118,  429 => 117,  423 => 114,  421 => 113,  419 => 112,  412 => 111,  403 => 106,  398 => 105,  396 => 104,  394 => 103,  387 => 102,  382 => 99,  375 => 98,  370 => 95,  363 => 94,  358 => 84,  350 => 88,  346 => 87,  342 => 86,  339 => 85,  337 => 84,  330 => 83,  325 => 72,  317 => 77,  313 => 76,  309 => 75,  305 => 74,  298 => 73,  296 => 72,  289 => 71,  284 => 68,  277 => 67,  272 => 64,  265 => 63,  260 => 51,  252 => 57,  248 => 56,  244 => 55,  240 => 54,  236 => 53,  227 => 52,  225 => 51,  218 => 50,  213 => 45,  206 => 44,  201 => 34,  197 => 41,  194 => 39,  191 => 38,  185 => 36,  182 => 35,  180 => 34,  173 => 33,  168 => 28,  166 => 27,  159 => 26,  154 => 178,  151 => 177,  149 => 170,  146 => 169,  144 => 162,  142 => 153,  140 => 144,  138 => 117,  135 => 116,  133 => 111,  130 => 110,  128 => 102,  125 => 101,  123 => 98,  120 => 97,  118 => 94,  115 => 93,  113 => 83,  110 => 82,  108 => 71,  105 => 70,  103 => 67,  100 => 66,  98 => 63,  95 => 62,  93 => 50,  90 => 49,  87 => 47,  85 => 44,  82 => 43,  80 => 33,  77 => 32,  74 => 30,  72 => 26,  35 => 25,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@PrestaShop/Admin/TwigTemplateForm/bootstrap_4_horizontal_layout.html.twig", "/opt/lampp/htdocs/presta/src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm/bootstrap_4_horizontal_layout.html.twig");
    }
}
