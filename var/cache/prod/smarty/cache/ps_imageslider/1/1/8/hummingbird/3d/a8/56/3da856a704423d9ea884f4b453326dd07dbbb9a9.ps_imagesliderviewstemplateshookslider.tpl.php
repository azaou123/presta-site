...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_699a1a78216565_80044142',
...
function content_699a1a78216565_80044142 (Smarty_Internal_Template $_smarty_tpl) {
?>
    ...
    <div class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox" aria-label="Conteneur carrousel">
            ...
            <a class="carousel-link" href="https://www.prestashop-project.org">              <figure class="carousel-content">
                <img src="http://localhost/presta/modules/ps_imageslider/images/sample-1.jpg" alt="sample-1" loading="eager" width=1110 height=340>
            ...
            aria-hidden="true">
            <a class="carousel-link" href="https://www.prestashop-project.org">              <figure class="carousel-content">
                <img src="http://localhost/presta/modules/ps_imageslider/images/sample-2.jpg" alt="sample-2" loading="lazy" width=1110 height=340>
                                  <figcaption class="carousel-caption caption">
            ...
            aria-hidden="true">
            <a class="carousel-link" href="https://www.prestashop-project.org">              <figure class="carousel-content">
                <img src="http://localhost/presta/modules/ps_imageslider/images/sample-3.jpg" alt="sample-3" loading="lazy" width=1110 height=340>
                                  <figcaption class="carousel-caption caption">
